...
export const axiosAuthGoogle = createAsyncThunk("authGoogle", async () => {
  const url = `${"https://server-agency-1203.onrender.com"}/user_system/auth/o/google-oauth2/?redirect_uri=https://critianrodriguez042502.github.io/agency_view/#/access/signin`;
